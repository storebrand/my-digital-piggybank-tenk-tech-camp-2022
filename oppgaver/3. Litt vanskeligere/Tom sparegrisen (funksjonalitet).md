...
- Grensen for når sparebøssen er full ligger i javascript-koden din, i putt-på-penger.js.
- Vi har brukt css for å skjule full-sparebosse-varsel-elementene. Du må bruke javascript for å endre denne css-en når sparebøssen er full, slik at de vises.
  Vi har skrevet en funksjon du kan bruke hvis du vil, den ligger i full-sparebosse.js. Prøv å finne ut hvor denne funksjonen må kalles for at varselet skal vises.
